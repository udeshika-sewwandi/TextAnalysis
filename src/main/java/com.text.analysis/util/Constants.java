...
public class Constants {
  ...
  public static String STUDENT_FEEDBACK_DATA = "src/main/resources/student_feedback_data.txt";
  public static String TWITTER_DATA = "src/main/resources/twitter_data.txt";
  public static String RESEARCH_PAPER_DATA = "src/main/resources/research_paper.txt";
  ...
  public static String LEMMATIZED_RESEARCH_PAPER_DATA = "src/main/resources/lemmatized_tokens/lemmatized_research_paper_data.txt";

  public static String STEMMED_STUDENT_FEEDBACK_DATA = "src/main/resources/stemmed_tokens/stemmed_student_feedback_data.txt";
  public static String STEMMED_TWITTER_DATA = "src/main/resources/stemmed_tokens/stemmed_twitter_data.txt";
  public static String STEMMED_RESEARCH_PAPER_DATA = "src/main/resources/stemmed_tokens/stemmed_research_paper.txt";
  ...
  public static String CONTEXT_SENSITIVE_SC_RESEARCH_PAPER_DATA = "src/main/resources/context-sensitive-spell-corrected/research_paper_cs_spell_corrected_data.txt";
}
